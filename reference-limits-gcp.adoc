...
對於Premium和BYOL授權、磁碟限制會讓您無法單獨使用磁碟、達到368TB容量限制。容量上限可達368TB https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-data-tiering.html["將非作用中資料分層至物件儲存設備"^]。如需詳細資料、請參閱下列磁碟限制。
